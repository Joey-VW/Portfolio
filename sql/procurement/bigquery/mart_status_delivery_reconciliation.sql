-- BigQuery / GoogleSQL adaptation of the status/delivery reconciliation mart.
-- Grain: one row per PO_ID. Source status and observed delivery evidence stay separate.
