const SAMPLE_IMAGE_URL = new URL("../postcard-atlas-fallback.svg", import.meta.url).href;
...
export const FEATURED_SAMPLE = {
  ...
  location: "Cedar Vale Lookout",
  mapGroupKey: "cedar-vale-lookout",
  clusterAnchor: "cluster-cedar-vale-lookout",
  latitude: 38.7000,
  longitude: -107.3000,
  mapUrl: "https://www.openstreetmap.org/?mlat=38.7000&mlon=-107.3000#map=13/38.7000/-107.3000",
};
